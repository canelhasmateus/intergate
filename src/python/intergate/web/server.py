...
from intergate.apis.discord.service import DiscordSend
...
from intergate.web.aspects.github.discord import GithubMessageFunction
from intergate.web.aspects.jira.discord import JiraMessageFunction
...
class Webserver:
	...
	def __init__( self, port: Integer, discordUrl: URL = None, jiraDomain: URL = None ):
		...
		self.send_message: DiscordMessager = DiscordSend( self.discordUrl )
		self.to_github_message: Function[ Dict, DiscordMessage ] = GithubMessageFunction()
		self.to_jira_message: Function[ Dict, DiscordMessage ] = JiraMessageFunction()
